...
contract('Exchange', ([deployer, feeAccount, user1, user2]) => {
    ...
    describe('fallback', () => {
        it('reverts when Ether is sent directly to the exchange', async () => {
    ...
    describe('depositing tokens', () => {
        ...
        describe('failure', () => {
            ...
            it('Don\'t allow Ether deposits', async () => {
    ...
    describe('withdrawing tokens', () => {
        ...
        describe('failure', () => {
            ...
            it('fails for insufficient balances', async () => {
                // Attempt to withdraw tokens without depositin any first
